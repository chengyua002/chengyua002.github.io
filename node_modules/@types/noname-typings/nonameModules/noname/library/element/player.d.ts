export class Player extends HTMLDivElement {
     ...
     */
    iterableGetGainableCards(player: [card: import("./card.js").Card, player: Player, target: Player, event?: string][1], arg1: Parameters<this['iterableGetCards']>[0], arg2: Parameters<this['iterableGetCards']>[1]): Generator<import("noname-typings/nonameModules/noname/library/element/card.js").Card, void, unknown>;
    /**
     *
     ...
     */
    getGainableCards(player: Parameters<this['iterableGetGainableCards']>[0], arg1?: Parameters<this['iterableGetGainableCards']>[1], arg2?: Parameters<this['iterableGetGainableCards']>[2]): import("noname-typings/nonameModules/noname/library/element/card.js").Card[];
    ...
    addSkills(skill: any): import("./gameEvent.js").GameEvent;
    removeSkills(skill: any): import("./gameEvent.js").GameEvent;
    changeSkills(addSkill?: any[], removeSkill?: any[]): import("./gameEvent.js").GameEvent;
     ...
     */
    getRoundHistory<T extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T, filter: (event: GameEventPromise) => boolean, num?: number, keep?: boolean, last: GameEventPromise): any[];
    /**
     ...
     */
    getHistory<T_1 extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T_1, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): ActionHistory[T_1];
    /**
     * 遍历历史
     * @template { Exclude<keyof ActionHistory,'isRound'|'isMe'> } T
     * @param { T } key
     ...
     */
    checkHistory<T_2 extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T_2, filter: (event: GameEventPromise) => void, last?: GameEventPromise): void;
    /**
     * @template { Exclude<keyof ActionHistory,'isRound'|'isMe'> } T
     * @param { T } key
     ...
     * @returns { boolean }
     */
    hasHistory<T_3 extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T_3, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): boolean;
    /**
     * 不填参数，直接获得最后一个回合的改玩家的整个历史对象。
     * @overload
     * @returns { ActionHistory }
     ...
     * @returns { ActionHistory[T] }
     */
    getLastHistory<T_4 extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T_4, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): ActionHistory[T_4];
    /**
     * 遍历整局游戏该玩家的历史
     * @template { Exclude<keyof ActionHistory,'isRound'|'isMe'> } T
     * @param { T } key
     ...
     * @param { GameEventPromise } [last]
     */
    checkAllHistory<T_5 extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T_5, filter: (event: GameEventPromise) => void, last?: GameEventPromise): void;
    /**
     * 获得整局游戏该玩家的行动历史
     * @overload
     * @returns { ActionHistory[] }
     ...
     * @returns { ActionHistory[T] }
     */
    getAllHistory<T_6 extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T_6, filter?: (event: GameEventPromise) => boolean, last?: GameEventPromise): ActionHistory[T_6];
    /**
     * @template { Exclude<keyof ActionHistory,'isRound'|'isMe'> } T
     * @param { T } key
     * @param { (event: GameEventPromise) => boolean } filter
     ...
     * @returns { boolean }
     */
    hasAllHistory<T_7 extends "useCard" | "useSkill" | "respond" | "gain" | "lose" | "damage" | "custom" | "skipped" | "sourceDamage">(key: T_7, filter: (event: GameEventPromise) => boolean, last?: GameEventPromise): boolean;
     ...
     * @returns {Stat[T]}
     */
    getStat<T_8 extends keyof Stat>(key: T_8): Stat[T_8];
    /**
     ...
     * @returns {Stat[T]}
     */
    getLastStat<T_9 extends keyof Stat>(key: T_9): Stat[T_9];
    queue(time: any): void;
     ...
     */
    mayHaveShan(viewer?: Player, type?: "use" | "respond", ignore?: Card[] | Card | null, rvt?: "bool" | "count" | "odds"): boolean | number;
