...
export class GameEvent implements PromiseLike<Omit<GameEvent, "then">> {
     ...
     */
    constructor(name?: string | GameEvent, trigger?: boolean, manager?: GameEventManager);
    /**
     * @type { string }
     */
    name: string;
    ...
    neutralize(event?: import("noname-typings/nonameModules/noname/library/element/gameEvent.js").GameEvent): Promise<Omit<GameEvent, "then">>;
    /**
     * @type { boolean }
     */
    _neutralized: boolean;
    _neutralize_event: import("noname-typings/nonameModules/noname/library/element/gameEvent.js").GameEvent;
    unneutralize(): void;
    goto(step: any): this;
    set step(num: number);
    get step(): number;
     ...
     */
    then<TResult1, TResult2>(onfulfilled?: (event: Omit<GameEvent, "then">) => TResult1 | Promise<TResult1>, onrejected?: (reason: any) => TResult2 | Promise<TResult2>): Promise<TResult1 | TResult2>;
    /**
     * @template TResult
     ...
     */
    catch<TResult>(onrejected?: (reason: any) => TResult | Promise<TResult>): Promise<Omit<GameEvent, "then"> | TResult>;
    /**
     ...
     */
    finally(onfinally?: (() => void) | null): Promise<Omit<GameEvent, "then">>;
    resolve(): void;
    start(): Promise<void>;
    loop(): Promise<void>;
